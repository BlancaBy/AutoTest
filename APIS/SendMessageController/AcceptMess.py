...
class AcceptMess():
    ...
    def send_request(self, request):
        self.config['url'] = self.config['url'].replace("{msg_id}", request['msg_id'])
        self.config['url'] = self.config['url'].replace("{msg_content}", request['msg_content'])
        self.config['url'] = self.config['url'].replace("{recv_time}", request['recv_time'])
        self.config['url'] = self.config['url'].replace("{sp_code}", request['sp_code'])
        self.config['url'] = self.config['url'].replace("{src_mobile}", request['src_mobile'])
