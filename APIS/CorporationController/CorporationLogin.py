...
class CorperationLogin():
    '''
    用户登录
        Method：POST
        URL：https://<base url>/user/v0/corporationLogin
        参数： {
        "accountName": "shangqi",
        "accountPwd": "shangqi",
        "corporationSerial": "001"
        }
    '''
    # region 初始化
    ...
    # region 业务操作
    # 发送request
    def send_request(self, accountName,accountPwd,corporationSerial):
        request = {}
        request['accountName']=accountName
        request['accountPwd']=accountPwd
        request['corporationSerial']=corporationSerial
